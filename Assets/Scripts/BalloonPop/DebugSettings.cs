//-----------------------------------------------------------------------
// <copyright file="DebugSettings.cs" company="Google">
//
...
namespace Google.CreativeLab.BalloonPop 
{
    ...
    public class DebugSettings : MonoBehaviour
    {
        ...
        [SerializeField] private bool _displayBalloonDebug = false;
        [SerializeField] private bool _fadeFarBalloons = false;

        public bool DisplayEarthDebug { get 
            { return !_allDebugOff && _displayEarthDebug; } 
        }
        public bool DisplayBalloonDebug { get 
            { return !_allDebugOff && _displayBalloonDebug; }
        }
        public bool FadeFarBalloons { get 
            { return !_allDebugOff && _fadeFarBalloons; }
        }
